# {{COMPANY_NAME}} — NWOS Workspace

> This repository does not just document {{COMPANY_NAME}}.
...
5. `protocols/P-001-briefing-agent-v1.md` — startup protocol
...
This repository contains the source of truth for all operations of {{COMPANY_NAME}}.

| Area | Path | Content |
| --- | --- | --- |
| 📜 Canon | `canon/` | Foundational documents. Immutable. |
...
| 🏰 Guilds | `guilds/` | Team structures and responsibilities. |

---

## System status

- **Active agents:** Pending deployment
- **Phase:** Setup
- **Oracle:** {{RESPONSIBLE_EMAIL}}
- **Autonomy level:** {{AUTONOMY_LEVEL}} / 10

---

## Configuration

| Axis | Level (1-10) | Description |
| --- | --- | --- |
| Narrative | {{NARRATIVE_LEVEL}} | Storytelling depth in agent communications |
| Gamification | {{GAMIFICATION_LEVEL}} | Game mechanics in missions and rewards |
| LLM Control | {{LLM_CONTROL_LEVEL}} | Degree of AI autonomy in operations |

> Level 1 = agents request permission for every action.
